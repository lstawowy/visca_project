...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            connect() {
                this.active0 = true;
                axios.post("https://localhost:10001/connect")
                    .then(response => {
            ...
            toggleUp() {
                this.active1 = true;
                axios.post("https://localhost:10001/up")
                    .then(response => {
                        this.posts = response.data
                    })
            },
            toggleLeft() {
                this.active2 = true;
                axios.post("https://localhost:10001/down")
                    .then(response => {
                        this.posts = response.data
                    })
            },
            toggleRight() {
                this.active3 = true;
                axios.post("https://localhost:10001/right")
                    .then(response => {
                        this.posts = response.data
                    })
            },
            toggleDown() {
                this.active4 = true;
                axios.post("https://localhost:10001/left")
                    .then(response => {
                        this.posts = response.data
                    })
            },
            zoomIn() {
                this.active5 = true;
                axios.post("https://localhost:10001/zoom_in")
                    .then(response => {
                        this.posts = response.data
                    })
            },
            zoomOut() {
                this.active6 = true;
                axios.post("https://localhost:10001/zoom_out")
                    .then(response => {
                        this.posts = response.data
                    })
            },
            rotate(value) {
                this.active7 = true;
                axios.post("https://localhost:10001/rotate/" + value)
                    .then(response => {
                        this.posts = response.data
                    })
            },
            switchToPort(value) {
                this.active7 = true;
                axios.post("https://localhost:10001/switch/" + value)
                    .then(response => {
                        this.posts = response.data
                    })
            }
